    ...
    def handle(self, *args, **options):
        ...
        sample_questions = [
            ...
            },
            {
                ...
                'options': ['var name', 'let age', 'const PI', 'variable count', 'declare value'],
            ...
            # Python Medium Questions
            {
                ...
                'options': ['The class itself', 'The instance of the class', 'A static reference', 'The parent class'],
                'correct_answers': [1],
            ...
            },
            {
                ...
                'options': ['More readable code', 'Better performance', 'Less memory usage', 'Automatic error handling', 'Built-in sorting'],
                'correct_answers': [0, 1, 2],
            ...
            },
            {
                ...
                'options': ['Shorter syntax', 'No own "this" binding', 'Cannot be used as constructors', 'Always anonymous', 'Automatically return values'],
                'correct_answers': [0, 1, 2],
            ...
            # Python Hard Questions
            {
                ...
                'options': ['A security feature', 'A mutex that allows only one thread to execute Python bytecode', 'A memory management system', 'A debugging tool'],
                'correct_answers': [1],
            ...
            },
            {
                ...
                'options': ['Using generators', 'Caching with functools.lru_cache', 'List comprehensions over loops', 'Using multiprocessing', 'Always using classes'],
            ...
            },
            {
                ...
                'options': ['useState hook', 'Class component state', 'useReducer hook', 'Global variables', 'Context API'],
            ...
            },
            {
                ...
                'options': ['Encapsulation', 'Inheritance', 'Polymorphism', 'Abstraction', 'Compilation'],
                'correct_answers': [0, 1, 2, 3],
        ...
        for question_data in sample_questions:
            ...
            if created:
                created_count += 1
                self.stdout.write(f'Created: {question_data["tech_stack"]} ({question_data["difficulty"]}) - {question_data["question_text"][:50]}...')
            else:
                self.stdout.write(f'Already exists: {question_data["tech_stack"]} ({question_data["difficulty"]})')
        
        self.stdout.write(
            self.style.SUCCESS(f'Successfully added {created_count} new questions to the question bank!')
        )

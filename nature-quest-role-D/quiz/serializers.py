...
class QuestionWithAnswersSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'question_type', 'question_text', 'options', 
                 'correct_answers', 'explanation', 'points', 'order']
...
class QuizSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Quiz
        fields = ['id', 'username', 'challenge_id', 'difficulty', 'tech_stack',
                 'total_questions', 'created_at', 'completed_at', 'score', 
                 'passed', 'is_completed']
...
class QuestionResponseSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['question', 'question_text', 'selected_answers', 'is_correct', 
...
class QuizAttemptSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = QuizAttempt
        fields = ['quiz_details', 'started_at', 'submitted_at', 'total_score', 
...
class QuestionBankSerializer(serializers.ModelSerializer):
    class Meta:
        model = QuestionBank
        fields = ['id', 'tech_stack', 'difficulty', 'question_type', 'question_text',
                 'options', 'correct_answers', 'explanation', 'times_used', 
...
class QuizMetricsSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = QuizMetrics
        fields = ['tech_stack', 'difficulty', 'total_quizzes', 'total_passes',

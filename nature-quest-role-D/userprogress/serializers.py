...
class BadgeSerializer(serializers.ModelSerializer):
    class Meta:
        model = Badge
        fields = ['animal', 'name', 'description', 'points_required', 'is_special', 'icon_url']
...
class PointsTransactionSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ['transaction_type', 'points', 'description', 'challenge_id', 
                 'quiz_id', 'created_at']
...
class UserProfileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = UserProfile
        fields = ['username', 'email', 'is_techie', 'tech_stacks', 'tech_stacks_list',
                 'total_points', 'current_level', 'challenges_completed', 
                 'quizzes_completed', 'quiz_difficulty_level', 'earned_badges',
    ...
    def get_tech_stacks_list(self, obj):
        ...
        if obj.tech_stacks:
            return [stack.strip() for stack in obj.tech_stacks.split(',') if stack.strip()]
        return []
...
class UserStatsSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = UserProfile
        fields = ['username', 'total_points', 'current_level_name', 'badges_count',

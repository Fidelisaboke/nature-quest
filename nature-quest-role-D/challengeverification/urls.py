...
router.register(r'admin/challenges', views.AdminChallengeViewSet, basename='admin-challenge')
router.register(r'admin/fraud-detection', views.AdminFraudDetectionViewSet, basename='admin-fraud')
